...
#
# macOS:  ./rust/scripts/gen-compile-commands.sh
# Linux:  OS=linux ./rust/scripts/gen-compile-commands.sh
set -euo pipefail
cd "$(dirname "$0")/../.."
...
node rust/scripts/filter-compdb.js /tmp/compdb.full.json c/compile_commands.json
