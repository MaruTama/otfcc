...
extern "C" {
    ...
    fn json_parse(json: *const ::core::ffi::c_char, length: size_t) -> *mut json_value;
    ...
    fn otfcc_Options_optimizeTo(options: *mut otfcc_Options, level: uint8_t);
...
pub unsafe extern "C" fn readEntireFile(
    ...
    buffer = malloc(length as size_t) as *mut ::core::ffi::c_char;
    if !buffer.is_null() {
        fread(
...
pub unsafe extern "C" fn readEntireStdin(
    ...
    let mut buffer: *mut ::core::ffi::c_char =
        malloc(BUF_SIZE as size_t) as *mut ::core::ffi::c_char;
    let mut length: ::core::ffi::c_long = 0 as ::core::ffi::c_long;
...
unsafe fn main_0(
    ...
    otfcc_Options_optimizeTo(options, 1 as uint8_t);
