...
#[no_mangle]
pub unsafe extern "C" fn otfcc_get_buf_len(mut buf: *mut caryll_Buffer) -> size_t {
    return (*buf).size;
}
#[no_mangle]
pub unsafe extern "C" fn otfcc_get_buf_data(mut buf: *mut caryll_Buffer) -> *mut uint8_t {
    return (*buf).data;
}
#[no_mangle]
