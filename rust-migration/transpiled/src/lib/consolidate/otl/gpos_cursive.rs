        ...
        if !otfcc_pkgGlyphOrder
            ...
            match _hj_k {
                11 => {
                    ...
                    current_block_52 = 3315936151729846072;
                }
                10 => {
                    current_block_52 = 3315936151729846072;
                }
                9 => {
                    current_block_52 = 2631076833836159093;
                }
                8 => {
                    current_block_52 = 7427138454918722041;
                }
                7 => {
                    current_block_52 = 7731642954199900691;
                }
                6 => {
                    current_block_52 = 939200501013471758;
                }
                5 => {
                    current_block_52 = 8144943921706072363;
                }
                4 => {
                    current_block_52 = 1368690349572628532;
                }
                3 => {
                    current_block_52 = 2332669000191205193;
                }
                2 => {
                    current_block_52 = 13131019356231169226;
                }
                1 => {
                    current_block_52 = 8861573525757737836;
                }
                _ => {
            ...
            if !s.is_null() {
                (*(*options).logger)
                    ...
                    sdscatprintf(
                        sdsempty(),
                        b"[Consolidate] Double-mapping a glyph in a cursive positioning /%s.\n\0"
                ...
                s = __caryll_allocate_clean(
                    ::core::mem::size_of::<gpos_cursive_hash>() as size_t,
                ...
                match _hj_k_0 {
                    11 => {
                        ...
                        current_block_174 = 3031444430934624633;
                    }
                    10 => {
                        current_block_174 = 3031444430934624633;
                    }
                    9 => {
                        current_block_174 = 10544429332333896974;
                    }
                    8 => {
                        current_block_174 = 13571897817355867746;
                    }
                    7 => {
                        current_block_174 = 2524143026478004996;
                    }
                    6 => {
                        current_block_174 = 6202706136215307904;
                    }
                    5 => {
                        current_block_174 = 4858086721458057569;
                    }
                    4 => {
                        current_block_174 = 10630599433215428982;
                    }
                    3 => {
                        current_block_174 = 6832773762126440008;
                    }
                    2 => {
                        current_block_174 = 11630333595416954884;
                    }
                    1 => {
                        current_block_174 = 1862645995592590714;
                    }
                    _ => {
                        current_block_174 = 5151888778912688305;
                    }
                }
